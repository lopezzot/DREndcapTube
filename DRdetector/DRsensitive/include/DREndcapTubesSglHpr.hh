...
inline G4int DREndcapTubesSglHpr::AttenuateHelper(const G4int& signal, const G4double& distance,
                                                  const G4double& attenuation_length)
{
...
inline void DREndcapTubesSglHpr::PrintStepInfo(const G4Step* aStep)
{
  std::cout << "-------------------------------" << std::endl;
